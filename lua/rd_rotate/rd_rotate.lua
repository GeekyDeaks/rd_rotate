...
-- remember the hour of the first race
local first_RaceDateHour = 0
...
local function advance_next_setup()
    ...
    if setup.RaceDateHour then
        setup.RaceDateHour = (setup.RaceDateHour + first_RaceDateHour) % 24
    end
...
local function set_first_setup()
    ...
    -- get the hour of the first race
    first_RaceDateHour = session.next_attributes.RaceDateHour
    print( "RDRotate: first_RaceDateHour = " .. first_RaceDateHour )
